...
REMOTE_SETTINGS_URL = (
    "https://thigschuch.github.io/SimpleConvertFile/settings/settings.json"
)
...
class SettingsManager:
    ...
    def __init__(self) -> None:
        ...
        self._user_config_dir = Path.home() / ".config" / "simpleconvertfile"
    ...
    def _check_remote_settings(self) -> None:
        ...
        try:
            ...
            req = urllib.request.Request(
                REMOTE_SETTINGS_URL,
                headers={"User-Agent": "SimpleConvertFile"},
            )
